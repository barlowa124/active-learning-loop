...
Written next to the outputs; it is part of the result, not a log.
"""
...
def manifest(inputs: list, config_path: str = "config/config.yaml") -> dict:
    import numpy
    import pandas
    import sklearn
